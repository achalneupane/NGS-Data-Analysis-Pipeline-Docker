### 2020-12-09 - README file for Macrogen_WGS sequences processing over at MGI
...
# Macrogen_WGS metadata file for the PROJECT in question
...
WORKLIST="${DEST}/Macrogen_WGS-worklist_fullsm.csv-missing"
...
'fernandezv@virtual-workstation1:/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW$ ls Macrogen_WGS/*/*.rgfile | wc -l
68
fernandezv@virtual-workstation1:/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW$ ls Macrogen_WGS/*/*.r1.fq.gz  | wc -l
68
'
## 2 - set the correct START and END for the workfile
