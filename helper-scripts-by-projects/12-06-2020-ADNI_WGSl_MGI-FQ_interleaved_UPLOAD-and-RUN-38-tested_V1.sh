# Updated on 10/08/2020 by Achal. This script was used to process ADNI samples from $PR: ADNI_WGS
...
# sed '/SRR1391349\|SRR1411264/d' ADNI_WGS_sm_dna-pr_rgbase_FQext_fullsm_1-250.csv > "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"

# After transferring metafile $FILE from Compute1, do this on MGI
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_1_to_25_samples.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_26_to_50_samples.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_51_to_75_samples.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_76_to_101_samples.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_1_to_25_samples.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_1_to_25_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_26_to_50_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_51_to_75_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_76_to_100_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_101_to_125_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_126_to_150_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_151_to_175_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_176_to_200_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_201_to_225_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_226_to_250_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_251_to_275_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_276_to_300_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_301_to_325_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_326_to_350_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_351_to_380_samples_batch2.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_1_to_50_samples_batch3.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_51_to_100_samples_batch3.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_101_to_150_samples_batch3.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_151_to_200_samples_batch3.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_201_to_250_samples_batch3.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_251_to_300_samples_batch3.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_301_to_350_samples_batch3.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
mv ${PR}_sm_dna-pr_rgbase_FQ1ext_FQ2ext_fullsm_1_to_35_samples_batch4.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
...
dir="/storage1/fs1/cruchagac/Active/achal/WXS_Aquilla/01-RAW/ADNI_WGS"

# 2, 18, 21

# ADNI_4026^LP6005118-DNA_D06^ADNI_WGS
# ADNI_4028^LP6005118-DNA_B01^ADNI_WGS
# ADNI_4029^LP6005117-DNA_H10^ADNI_WGS
# ADNI_4030^LP6005118-DNA_F04^ADNI_WGS
# ADNI_4032^LP6005117-DNA_E11^ADNI_WGS
# ADNI_4034^LP6005118-DNA_H10^ADNI_WGS
# ADNI_4035^LP6005118-DNA_E09^ADNI_WGS
# ADNI_4039^LP6005118-DNA_E02^ADNI_WGS
# ADNI_4041^LP6005118-DNA_G05^ADNI_WGS
# ADNI_4042^LP6005118-DNA_A01^ADNI_WGS

# redo 13
# ADNI_4188^LP6005120-DNA_G03^ADNI_WGS
...
# rsync with copy referent files as we are copying symlinks for this ADNI data from Compute1
