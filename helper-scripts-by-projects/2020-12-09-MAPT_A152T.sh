...
## MAPT_A152T like DIAN have several bams that need to be merged
...
WORKLIST="${DEST}/${PR}-worklist_fullsm.csv-missing"
...
`fernandezv@virtual-workstation1:/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW$ ls MAPT_A152T/*/*.r1.fq.gz | wc -l
36
fernandezv@virtual-workstation1:/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW$ ls MAPT_A152T/*/*.rgfile | wc -l
36`
