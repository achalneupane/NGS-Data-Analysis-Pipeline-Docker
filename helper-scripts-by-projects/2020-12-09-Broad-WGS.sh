################################
# 2020-01-03 - Broad_WGS 
################################

SOURCEDIR="/40/AD/AD_Seq_Data/01.-RawData/Broad_WGS/bam"
...
ls Broad_WGS/bam/*/*.bam | cut -d "/" -f 4 | cut -d "." -f1 > Broad_WGS-worklist-fullsm.csv
ls Broad_WGS/bam/*/*.bam | cut -d "/" -f 4 | awk -F "." '{print $1"."$2}' > Broad_WGS-bamfiles.list

ls Broad_WGS/bam/*/*.bam | cut -d "/" -f 4 | cut -d "." -f1 | awk -F "^" '{print $1","$2","$3","}' > Broad_WGS-meatdata-head
paste Broad_WGS-meatdata-head Broad_WGS-bamfiles.list| sed 's/\t//g' > Broad_WGS-sm_dna_pr_bamfile.csv
...
for FULLSM in $(sed -n "${START},${END}p" "${WORKLIST}"); do \
	...
	SOURCE="/40/AD/AD_Seq_Data/01.-RawData/Broad_WGS/bam/${FULLSM}";\
...
ls ../02-TRANSIT/Broad_WGS/*/*.vcf.gz | wc -l
98
## launch second set
...
GVCF file for sample 11_15_15.201^8006302878^Broad_WGS is NOT complete
GVCF file for sample 11_8_8.226^8008285859^Broad_WGS    11_8_8.226^8008285859^Broad_WGS.H22CV^4 is NOT complete
GVCF file for sample 65467^8006305441^Broad_WGS is NOT complete
GVCF file for sample 65533^8005873588^Broad_WGS is NOT complete
GVCF file for sample ADNI_0814^8006304109^Broad_WGS is NOT complete
GVCF file for sample ADNI_1035^8006303895^Broad_WGS is NOT complete
GVCF file for sample ADNI_1263^8006303805^Broad_WGS is NOT complete
GVCF file for sample ADNI_1295^8006303449^Broad_WGS is NOT complete
GVCF file for sample ADNI_1334^8006303427^Broad_WGS is NOT complete
GVCF file for sample ADNI_1373^8006303758^Broad_WGS is NOT complete
GVCF file for sample ADNI_1409^8006303784^Broad_WGS is NOT complete

### Let's launch these samples again. Place them on a new file:
11_15_15.201^8006302878^Broad_WGS
11_8_8.226^8008285859^Broad_WGS
65467^8006305441^Broad_WGS
65533^8005873588^Broad_WGS
ADNI_0814^8006304109^Broad_WGS
ADNI_1035^8006303895^Broad_WGS
ADNI_1263^8006303805^Broad_WGS
ADNI_1295^8006303449^Broad_WGS
ADNI_1334^8006303427^Broad_WGS
ADNI_1373^8006303758^Broad_WGS
ADNI_1409^8006303784^Broad_WGS
...
06 - ValidateSam-III on 11_8_8.226^8008285859^Broad_WGS.aln.srt.isec-paddedexome.markd.bam
"11_8_8.226^8008285859^Broad_WGS_s05mrkdup: No matching job found. Job not submitted.
07 - Depth of Coverage
"11_8_8.226^8008285859^Broad_WGS_s06vldate: No matching job found. Job not submitted.
08 - Base Recalibrator
"11_8_8.226^8008285859^Broad_WGS_s06vldate: No matching job found. Job not submitted.
09 - ValidateSam IV on 11_8_8.226^8008285859^Broad_WGS.aln.srt.isec-paddedexome.markd.recal.bam
"11_8_8.226^8008285859^Broad_WGS_s08bsercl: No matching job found. Job not submitted.
10 - Haplotype Caller
"11_8_8.226^8008285859^Broad_WGS_s09vldate: No matching job found. Job not submitted.
11 - VariantEval
"11_8_8.226^8008285859^Broad_WGS_s07dcvrge: No matching job found. Job not submitted.
Finished submitting jobs for 11_8_8.226^8008285859^Broad_WGS
Finished submitting per-bam jobs for 11_8_8.226^8008285859^Broad_WGS
Create directory /gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW/Broad_WGS/65467^8006305441^Broad_WGS
mkdir: cannot create directory ‘/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW/Broad_WGS/65467^8006305441^Broad_WGS’: File exists

### Need to resend 11_8_8.226^8008285859^Broad_WGS


##Missing samples & failed steps:
11_15_15.201^8006302878^Broad_WGS --> "failed at 06_validate mark duplicates bam"
11_8_8.226^8008285859^Broad_WGS --> FINISIHED
65467^8006305441^Broad_WGS --> "STOP at markduplicates" --> FINISHED
65533^8005873588^Broad_WGS --> "STOP at markduplicates" --> FINISHED
ADNI_0814^8006304109^Broad_WGS --> "doesn't go beyond revertbam - in theory it's successfully completed but no bam is generated, but there are some syntax error along the way" --> FINISHED
ADNI_1035^8006303895^Broad_WGS --> "doesn't go beyond revertbam - in theory it's successfully completed but no bam is generated, but there are some syntax error along the way" --> FINISHED
ADNI_1263^8006303805^Broad_WGS --> "doesn't go beyond revertbam - in theory it's successfully completed but no bam is generated, but there are some syntax error along the way" --> FINISHED
ADNI_1295^8006303449^Broad_WGS --> "doesn't go beyond revertbam - in theory it's successfully completed but no bam is generated, but there are some syntax error along the way" --> FINISHED
ADNI_1334^8006303427^Broad_WGS --> "doesn't go beyond revertbam - in theory it's successfully completed but no bam is generated, but there are some syntax error along the way" --> FINISHED
ADNI_1373^8006303758^Broad_WGS --> "doesn't go beyond revertbam - in theory it's successfully completed but no bam is generated, but there are some syntax error along the way" --> FINISHED
ADNI_1409^8006303784^Broad_WGS --> "doesn't go beyond revertbam - in theory it's successfully completed but no bam is generated, but there are some syntax error along the way" --> FINISHED


### 2020-01-21 
## Need to resend the 11_15_15.201^8006302878^Broad_WGS
START=1; END=1; 
DELAY=10
EMAIL="fernandezv@wustl.edu"
SHELLDROP=0
...
echo -e "06 - ValidateSam-III on ${FULLSM}.aln.srt.isec-${RUN_TYPE}.markd.bam"
WORKDIR="/gscmnt/gc2645/wgs/WXS_Aquilla/02-TRANSIT/Broad_WGS/11_15_15.201^8006302878^Broad_WGS"
BASE="/gscmnt/gc2645/wgs"
	export MEM=6; \
	export BAMFILE="${WORKDIR}/11_15_15.201^8006302878^Broad_WGS.aln.srt.isec-paddedexome.markd.bam"; \
	export REF="${BASE}/Genome_Ref/GRCh38/Homo_sapiens_assembly38.fasta"; \
	bsub \
    -J "${FULLSM}_s06vldate" \
    -o "${BASE}/WXS_Aquilla/02-TRANSIT/${PR}/${FULLSM}/${FULLSM}_s06vldate.%J" \
...
fernandezv@virtual-workstation4:/gscmnt/gc2645/wgs/WXS_Aquilla/02-TRANSIT/Broad_WGS/11_15_15.201^8006302878^Broad_WGS$ cat 11_15_15.201^8006302878^Broad_WGS_s06vldate.1226764
