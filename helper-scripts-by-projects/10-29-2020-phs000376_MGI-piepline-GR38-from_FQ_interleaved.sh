### README file for phs000376 sequences processing over at MGI 
...
FQDIR="/30/dbGaP/6109/sra/phs000572_201802/phs000376"
PR="phs000376"


# mv phs000376_sm_dna-pr_rgbase_FQext_fullsm_101_150_samples.csv  "${PR}_sm_dna-pr_rgbase_fq1ext_fq2ext_fullsm.csv"
mv ${PR}_sm_dna-pr_rgbase_FQext_fullsm_44_samples.csv  "${PR}_sm_dna-pr_rgbase_fq1ext_fq2ext_fullsm.csv"
...
# ./PDMiami192^SRR2986756^phs000376
