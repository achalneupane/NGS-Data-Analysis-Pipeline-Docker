### 11-30-2020 - README file for 202002_Mendelics_DIANEXR_WES_UNNAMED sequences processing over at MGI



# generate metadata file for the PROJECT in question
HOMEDIR="/40/AD/AD_Seq_Data/01.-RawData"
PR="202002_Mendelics_DIANEXR_WES_UNNAMED"
...
awk -F"," '{print $1","$2","$4","$3}' ${LOOKUP} > ${PR}-MGIID-SMID-DNA-PR-BAMFILE.${LOOKUP##*.}; done
...
echo -e "${FULLSM}\n${CRAMFILE}\n${SM}\n${DNA}\n${PR}\n${BAMFILE}\n${FBASE}\n${FILE_BAM}" 
DIANBR017-1^VB98052701^202002_Mendelics_DIANEXR_WES_UNNAMED
DIANBR017-1
VB98052701
202002_Mendelics_DIANEXR_WES_UNNAMED
QRC668-002_4_ATGTTGTTGGCAATCTATGA.bam
/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW/202002_Mendelics_DIANEXR_WES_UNNAMED/DIANBR017-1^VB98052701^202002_Mendelics_DIANEXR_WES_UNNAMED
/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW/202002_Mendelics_DIANEXR_WES_UNNAMED/DIANBR017-1^VB98052701^202002_Mendelics_DIANEXR_WES_UNNAMED/QRC668-002_4_ATGTTGTTGGCAATCTATGA.bam
...
((Snumber=Snumber+1)); \
	...
	FENIX_BAM="/40/AD/AD_Seq_Data/01.-RawData/202002_Mendelics_DIANEXR_WES_UNNAMED/bams/${SM}/${BAMBASE}"
	rsync -avh -L ${USER}@fenix.psych.wucon.wustl.edu:${FENIX_BAM} ${OUT_DIR}/ ;\
...
# create FASTQ metafile 
DIR="/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW/202002_Mendelics_DIANEXR_WES_UNNAMED"
OUTDIR="/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW"
cd $DIR
for s in $(ls ${DIR}); do
echo ${s}
SM="$(echo ${s}| cut -d^ -f1)"
...
Read2="r2.fastq"
RGBASE=${R1/".rgfile"/}
echo "${SM},${DNA},${PR},${RGBASE},${Read1},${Read2},${FULLSM}"  >> ${OUTDIR}/${PR}_SM_DNA_PR_RGBASE_R1_R2_FULLSM_metafile.csv
# echo "${SM},${DNA},${PR},${RGBASE},${Read1},${Read2},${FULLSM}"
done
cd ..
done


# RUN the pipeline from FASTQ
LOOKUP="${OUTDIR}/${PR}_SM_DNA_PR_RGBASE_R1_R2_FULLSM_metafile.csv"
#Generate the workfile
cut -d, -f1-3 ${LOOKUP} | tr "," "^" | sort -u > ${OUTDIR}/${PR}-worklist_fullsm.csv
WORKLIST="${OUTDIR}/${PR}-worklist_fullsm.csv"
