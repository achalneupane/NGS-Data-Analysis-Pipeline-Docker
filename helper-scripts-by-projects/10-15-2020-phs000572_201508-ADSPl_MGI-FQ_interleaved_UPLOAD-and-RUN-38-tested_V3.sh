# Updated on 10/08/2020 by Achal. This script was used to process ADSP samples from $PR: phs000572_201508
# First use phs000572_201508.sh script to download ADSP SRAs, then use Create_metafile.sh to create metafile for this project. 
unset all ENV variables
for c in $(env | cut -d '=' -f 1); do unset $c; done

cd /30/dbGaP/6109/sra/phs000572_201508/fqgz
...
# sed '/SRR1391349\|SRR1411264/d' phs000572_201508_sm_dna-pr_rgbase_FQext_fullsm_1-250.csv > "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"

mv ${PR}_sm_dna-pr_rgbase_FQext_fullsm_117_samples.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
...
FBASE="/30/dbGaP/6109/sra/phs000572_201508/fqgz/${FULLSM}"; \
