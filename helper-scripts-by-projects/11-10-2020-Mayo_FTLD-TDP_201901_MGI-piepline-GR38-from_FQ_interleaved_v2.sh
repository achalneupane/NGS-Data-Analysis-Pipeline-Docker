...
FQDIR="/40/AD/AD_Seq_Data/01.-RawData/Mayo_FTLD-TDP_201901"
PR="Mayo_FTLD-TDP_201901"


# mv phs000901_sm_dna-pr_rgbase_FQext_fullsm_101_150_samples.csv  "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
mv ${PR}_sm_dna-pr_rgbase_FQext_fullsm_11_samples.csv  "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
...
RGFILE="/home/achal/01.-RawData/Mayo_FTLD-TDP_201901/${RGBASE}.rgfile";\
