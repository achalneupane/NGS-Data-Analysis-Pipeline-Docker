# Updated on 10/08/2020 by Achal. This script was used to process ADSP samples from $PR: phs000572_201707
# First use phs000572_201707.sh script to download ADSP SRAs, then use Create_metafile.sh to create metafile for this project. 


unset all ENV variables
for c in $(env | cut -d '=' -f 1); do unset $c; done

cd /30/dbGaP/6109/sra/phs000572_201707/fqgz
...
# sed '/SRR1391349\|SRR1411264/d' phs000572_201707_sm_dna-pr_rgbase_FQext_fullsm_1-250.csv > "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"

mv phs000572_201707_sm_dna-pr_rgbase_FQext_fullsm_94_samples.csv "${PR}_sm_dna-pr_rgbase_FQext_fullsm.csv"
# ## get only lines matching patterns
# cat phs000572_201707_sm_dna-pr_rgbase_FQext_fullsm_1-250.csv | grep "SRR1391349\|SRR1411264"
##############
## 2019-08-02
##############
...
FBASE="/30/dbGaP/6109/sra/phs000572_201707/fqgz/${FULLSM}"; \
...
for x in $(cat ${WORKLIST}); do ls -lh ../02-TRANSIT/phs000572_201707/${x}/*.vcf.gz; done

### CLEANING UP FASTQ files for phs000572_201707
# 1 - generate a list of gvcf files finished, just keep the FULLSMID info
ls ../02-TRANSIT/phs000572_201707/*/*.g.vcf.gz | cut -d "/" -f 4 | sort | uniq > phs000572_201707-fqtodelete.list
ls ../02-TRANSIT/phs000572_201707/*/*.g.vcf.gz | cut -d "/" -f 4 | sort | uniq > phs000572_201707-fqtodelete.list2

cat phs000572_201707-fqtodelete.list2 phs000572_201707-fqtodelete.list | sort | uniq -c | awk '{if ($1==1) print $2}' > phs000572_201707-fqtodelete.LIST

## delete all fastq & cram within that FULLSMID directory for the samples that gvcf is completed
for x in $(cat phs000572_201707-fqtodelete.list); do rm phs000572_201707/${x}/*.fq.gz; done
for x in $(cat phs000572_201707-fqtodelete.list); do rm ../02-TRANSIT/phs000572_201707/${x}/*.bam; done




ls ../02-TRANSIT/phs000572_201707/*/*.bam | wc -l
ls ./phs000572_201707/*/*.fq.gz | wc -l

ls ../02-TRANSIT/phs000572_201707/*/*.aln.srt.bam | wc -l
265
ls ../02-TRANSIT/phs000572_201707/*/*.aln.srt.isec-paddedexome.markd.bam | wc -l
32
ls ../02-TRANSIT/phs000572_201707/*/*.aln.srt.isec-*.markd.bam | wc -l
32
ls ../02-TRANSIT/phs000572_201707/*/*.aln.srt.isec-*.markd.recal.table1 | wc -l
32
ls ../02-TRANSIT/phs000572_201707/*/*.aln.srt.isec-*.markd.exome-coverage.sample_statistics | wc -l
31
ls ../02-TRANSIT/phs000572_201707/*/*.aln.srt.isec-*.markd.exome-coverage.sample_summary | wc -l
31
ls ../02-TRANSIT/phs000572_201707/*/*.aln.srt.isec-*.markd.recal.raw.snps.indels.g.vcf.gz | wc -l
82

### CLEAR UP SOME FILES:
fernandezv@virtual-workstation1:/gscmnt/gc2645/wgs/WXS_Aquilla/01-RAW$ rm ./phs000572_201707/*/*.fastq
